    ...
    render()
    {
        return (
            <div className="HowToScreen">
                ...
                <button class="btn-howTo" onClick={this.onBack.bind(this)} style={{top:"-60px", left:"-250px"}}>BACK</button>
                    <div id="HowToScreen-Help" style={{textAlign:"left", maxWidth:"600px", margin:"auto", color:"#181425"}}>
